  ...
  Future<void> seedTasks() async {
    ...
    final tasks = [
      ...
      TaskModel(
        ...
        type: TaskTypes.winter,
        pointReward: 20,
        requiredAction: TaskActions.winterReportPoint,
        requiredCount: 1,
        isWinterOnly: true,
        iconEmoji: '❄️',
        sortOrder: 70,
      ...
      TaskModel(
        id: 'weekly_report_broken_point',
        title: 'Yakındaki bozuk kutuyu bildir',
        description:
            'Yakındaki bozuk, dolu veya eksik geri dönüşüm noktasını bildir.',
        type: TaskTypes.weekly,
        pointReward: 30,
        requiredAction: TaskActions.reportBrokenPoint,
        requiredCount: 1,
        isWinterOnly: false,
        iconEmoji: '📍',
        sortOrder: 75,
